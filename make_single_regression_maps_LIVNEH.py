...
if __name__ == '__main__':
    ...
    for var_name in ['tmin', 'tmax']:
        print('VAR ' + var_name)
        slopes_temps, slopes_sums, lons, lats = get_array_data(var_name, years, data_dir)
        out_file = data_dir + var_name + '_temps_slopes.tif'
        array_to_raster(lats, lons, slopes_temps, out_file, nodata=-9999)
        out_file = data_dir + var_name + '_sums_slopes.tif'
