...
if __name__ == '__main__' :
    netfiles = filter(os.path.isfile, glob.glob('RESULTS/loca/CNRM-CM5/' + 'tmax_rcp85_5th_Indices_WUSA_*.nc'))
    for netfile in netfiles[0:5]:
        print netfile
        check_indices(netfile)

    '''
    netfile = 'RESULTS/livneh/tmin_percentiles.nc'
    #netfile = 'RESULTS/loca/CNRM-CM5/tmin_rcp85_percentiles.nc'
